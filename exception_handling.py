# 1. Implement functions that might raise common exceptions (e.g., file not found, division by zero, invalid user input).
# 2. Use try-except blocks to catch and handle these exceptions appropriately.
